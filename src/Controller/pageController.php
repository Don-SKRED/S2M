       ...
       if($form->isSubmitted() && $form->isValid())
       {
           ...
           foreach ($data as $row) {
               $insert_data = array(
                 ...
                 $query = "INSERT INTO upload ( nom, prenom, numero, courier_id, valide, is_disabled, n_bl, second_valide) VALUES ( :nom, :prenom, :numero, :courier_id, :valide, :is_disabled, :n_bl, :second_valide)";
